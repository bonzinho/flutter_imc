...
class _HomeState extends State<Home> {
  ...
  String _infoText = "Informe os dados necessários ao cálculo";
  ...
  void _resetFields(){
    ...
    setState(() {
      _infoText = "Informe os dados necessários ao cálculo";
    });
  }
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Form(
          key: _formKey,
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.stretch, // vai fazer com que tudo ocupe toda a largura do smartphone
            children: <Widget>[
